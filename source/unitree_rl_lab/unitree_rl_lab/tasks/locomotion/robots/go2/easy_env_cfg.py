...
EASY_TERRAIN_CFG = terrain_gen.TerrainGeneratorCfg(
    size=(8.0, 8.0),
    border_width=20.0,
    num_rows=10,
    num_cols=20,
...
class RobotSceneCfg(RobotSceneCfgBase):
    ...
    terrain = TerrainImporterCfg(
        ...
        terrain_generator=EASY_TERRAIN_CFG,
...
class RobotPlayEnvCfg(RobotEnvCfg):
    def __post_init__(self):
        ...
        self.scene.terrain.terrain_generator.num_cols = len(EASY_TERRAIN_CFG.sub_terrains)
